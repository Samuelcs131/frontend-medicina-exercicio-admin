<template>
  <q-page class="container q-layout-padding">
    <h1 class="text-h5">Grupos de subespecialidade</h1>
    ...
    >
      <template #top-right>
        <action-header
          label-new-entity="Novo grupo de subespecialidade"
    ...
    <action-dialog
      ...
      prefix="os"
      title="grupos de subespecialidades"
        ...
        <q-form @submit="save">
          <q-card-section class="q-py-none q-pt-sm">
            <h6 class="text-h6 q-my-none">
              {{ state.form.id ? 'Editar' : 'Criar' }} grupo de subespecialidade
            </h6>
          </q-card-section>
